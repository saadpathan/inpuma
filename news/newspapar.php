...
<head>
	...
	<style type="text/css">
		.rs-toolbar {
			background-color: <?php echo $IconBg;?>;
		}
		...
		/* image bg footer */
		.bg3 {
  			background-image: url(../<?php echo $FooterImageURL;?>);
  			background-size: cover;
						...
						<div class="col-md-6">
							<div class="rs-toolbar-left">
								<div class="welcome-message">
									<!--<i class="fa fa-graduation-cap"></i>--><span>Welcome to <?php echo $NameSite;?></span> 
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="rs-toolbar-right">
								<div class="toolbar-share-icon">
									<ul>
										...
										<li><a href="<?php echo $YoutubeURL;?>" target="_blank"><i class="fa fa-youtube"></i></a></li>
										<li><a href="<?php echo $InstagramURL;?>" target="_blank"><i class="fa fa-instagram"></i></a></li>
									</ul>
								</div>
								    ...
								    <div class="col-sm-4">
								        <div class="header-contact" id="mysis">
								            <div id="info-details" class="widget-text">
								                ...
								                <div class="info-text">
								                    <a href="https://mysis.um.edu.my" target="_blank">
								                    	<span>Go to MySIS</span>
														Click for Login
													</a>
								                </div>
								            </div>
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<nav class="rs-menu">
										<ul class="nav-menu">
<?php
	$stmt = mysqli_prepare($dbi, "SELECT id, parent, title, link, target_window  FROM menu_cimp where SiteId=? and admin='0' and active='1' order by menupos");
	...
	for ($bil = 0; $bil < $bilmenu; $bil++) { //Start for looping -----------
		...
		if ($submenu == "Y"){ //Start submenu 1 -------------
			...
			$stmt2 = mysqli_prepare($dbi, "SELECT id, parent, title, link, target_window FROM menu_cimp2 where SiteId=? and  parent=? and admin='0' and active='1' order by menupos");
		...
		if ($submenu == "Y"){ //Start submenu 1 -------------
			...
			for ($bil2 = 0; $bil2 < $bilparentsub[$bil]; $bil2++) { //Start for looping -----------
				...
				if ($submenu2 == "Y"){ //Start submenu 2 -------------
					...
					$stmt3 = mysqli_prepare($dbi, "SELECT id, parent, title, link, target_window FROM menu_cimp3 where SiteId=? and  parent=? and admin='0' and active='1' order by menupos");
		            ...
		            <div class="row">
		                <div class="col-md-12 text-center">
		                    ...
		                    <ul>
		                        ...
		                        <li>
		                            <a class="active" href="index">News</a>
		                        </li>
...
?>					
        ...
        <footer id="rs-footer" class="bg3 rs-footer">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="copyright">
                        <p>© 2020 <a href="https://ptm.um.edu.my" target="_blank">Pusat Teknologi Maklumat</a>. All Rights Reserved&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://um.edu.my/privacy-policy/privacy-policy" target="_blank">Privacy Policy</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://um.edu.my/privacy-policy/site-credits" target="_blank">Site Credits</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://um.edu.my/privacy-policy/disclaimer" target="_blank">Disclaimer</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://um.edu.my/privacy-policy/security-policy" target="_blank">Security Policy</a></p>
                    </div>
                </div>
            </div>
        </footer>
