...
mysqli_stmt_bind_result($qryNews, $dataNews["id"], $dataNews["title"], $dataNews["image"], $dataNews["content"], $dataNews["counter"], $dataNews["startdate"]);
$bilnews = 1;
