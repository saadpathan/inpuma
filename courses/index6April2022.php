...
$qryNews = mysqli_prepare($dbi, "SELECT title, division, length, commitment, pace, subject, platform, credit, image, content FROM courses where SiteId = ? and active = '1' order by datecreated desc");
