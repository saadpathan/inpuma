...
*/
$stmt = mysqli_prepare($dbi, "SELECT title, division, length, commitment, pace, subject, platform, credit, image, datecreated, content, active, startevent, endevent, imagelec, biolec FROM courses where id = ?");
mysqli_stmt_bind_param($stmt, "i", $id);
mysqli_stmt_execute($stmt);
mysqli_stmt_bind_result($stmt, $titleHTML, $division, $length, $commitment, $pace, $subject, $platform, $credit, $image, $datecreated, $contentHTML, $active, $startevent, $endevent, $imagelec, $biolec);
...
$imglecpath = "Image/Courses/".$imagelec;
		            ...
		            <div class="row">
		                <div class="col-md-12 text-center">
		                    ...
		                    <ul>
		                        ...
		                        <li>
		                            <a class="active" href="indexcourses.php?noic=<?php echo $SiteId;?>">Courses</a>
		                        </li>
                ...
                <div class="row mb-30">
                    <div class="col-lg-8 col-md-12">
                	    <div class="detail-img">
                	        <img src="<?php echo $urlsite.$imgpath;?> " alt="Courses Images" />
                	    </div>
							...
							<div class="course-instructor">
                	    				...
                	    				<div class="instructor-inner">
                	    					<div class="instructor-img">
                	    						<img src="<?php echo $urlsite.$imglecpath;?>" alt="Teachers Images" />
                	    					</div>
        ...
        <div id="rs-calltoaction" class="rs-calltoaction sec-spacer bg4">
            <div class="container">
                <div class="rs-cta-inner text-center">
				    <a class="cta-button" href="#">ENROLL NOW</a>
				</div>
            </div>
        </div>
        <!-- Calltoaction End -->
