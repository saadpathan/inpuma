...
$qryNews = mysqli_prepare($dbi, "SELECT title, division, length, commitment, pace, subject, platform, credit, image, content FROM courses where SiteId = ? and active = '1' and division NOT IN ('ocw') order by dateupdate desc");
...
while (mysqli_stmt_fetch($qryNews)) {
	...
	echo "				<h4 class=\"course-category\"><a href=\"".$pautan."\">".$title."</a></h4>\n";
	echo "				<div class=\"course-date\"><i class=\"fa fa-folder-o\"></i> ".$subject."</div>\n";
	echo "				<div class=\"course-duration\"><i class=\"fa fa-laptop\"></i> ".$pace."</div>\n";
	...
	echo "			<div class=\"course-seats\"><i class=\"fa fa-calendar\"></i> ".$length." WEEKS (".$commitment." HRS/WEEK)</div>\n";
...
$qryNews = mysqli_prepare($dbi, "SELECT title, division, length, commitment, pace, subject, platform, credit, image, content FROM courses where SiteId = ? and active = '1' and division = 'ocw' order by dateupdate desc");
