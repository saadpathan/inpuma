...
*/
$stmt = mysqli_prepare($dbi, "SELECT title, division, length, commitment, pace, subject, platform, credit, image, datecreated, content, active, startevent, endevent, urlenroll, imagelec, biolec FROM courses where id = ?");
mysqli_stmt_bind_param($stmt, "i", $id);
mysqli_stmt_execute($stmt);
mysqli_stmt_bind_result($stmt, $titleHTML, $division, $length, $commitment, $pace, $subject, $platform, $credit, $image, $datecreated, $contentHTML, $active, $startevent, $endevent, $urlenroll, $imagelec, $biolec);
							...
							<!--<div class="course-instructor">
                	    				...
                	    				<div class="instructor-inner">
                	    					<div class="instructor-img">
                	    						<img src="<?php echo $imglecpath;?>" alt="Teachers Images" />
                	    					</div>
